...
Rcpp::List reml_sliding_window_part(const std::string& filename, const SEXP pheno_mat, const IntegerMatrix snp_cat, const CharacterVector cat_names, double window_size, int min_snps, double alpha, double alpha_common, Rcpp::Nullable<Rcpp::String> common_filename, int max_iter, double tol, bool se, std::string out_file, int batch_size, int n_threads, int seed, Rcpp::Nullable<Rcpp::NumericVector> weights, Rcpp::Nullable<Rcpp::NumericMatrix> covariates, int collapse_mac, int collapse_n);
RcppExport SEXP _StratGWAS_reml_sliding_window_part(SEXP filenameSEXP, SEXP pheno_matSEXP, SEXP snp_catSEXP, SEXP cat_namesSEXP, SEXP window_sizeSEXP, SEXP min_snpsSEXP, SEXP alphaSEXP, SEXP alpha_commonSEXP, SEXP common_filenameSEXP, SEXP max_iterSEXP, SEXP tolSEXP, SEXP seSEXP, SEXP out_fileSEXP, SEXP batch_sizeSEXP, SEXP n_threadsSEXP, SEXP seedSEXP, SEXP weightsSEXP, SEXP covariatesSEXP, SEXP collapse_macSEXP, SEXP collapse_nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::string& >::type filename(filenameSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const SEXP >::type pheno_mat(pheno_matSEXP);
    Rcpp::traits::input_parameter< int >::type chunk_size(chunk_sizeSEXP);
    Rcpp::traits::input_parameter< int >::type flank_chunks(flank_chunksSEXP);
    Rcpp::traits::input_parameter< int >::type min_chunk_snps(min_chunk_snpsSEXP);
    Rcpp::traits::input_parameter< double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< double >::type alpha_common(alpha_commonSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::String> >::type common_filename(common_filenameSEXP);
    Rcpp::traits::input_parameter< double >::type common_window(common_windowSEXP);
    Rcpp::traits::input_parameter< int >::type max_common_snps(max_common_snpsSEXP);
    Rcpp::traits::input_parameter< std::string >::type out_file(out_fileSEXP);
    Rcpp::traits::input_parameter< int >::type batch_size(batch_sizeSEXP);
    Rcpp::traits::input_parameter< int >::type n_threads(n_threadsSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericVector> >::type weights(weightsSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type coher(coherSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerMatrix> >::type pairs(pairsSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type binary_raw(binary_rawSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericVector> >::type binary_gap(binary_gapSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::String> >::type grm_prefix(grm_prefixSEXP);
    Rcpp::traits::input_parameter< int >::type grm_probes(grm_probesSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type grm_seed(grm_seedSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerMatrix> >::type annotation(annotationSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type annot_names(annot_namesSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterMatrix> >::type loco_prs(loco_prsSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerMatrix> >::type prs_mask(prs_maskSEXP);
    Rcpp::traits::input_parameter< int >::type chunk_size(chunk_sizeSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type batch_size(batch_sizeSEXP);
    Rcpp::traits::input_parameter< int >::type n_threads(n_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(stratgwas_run(filename, pheno_mat, annotation, annot_names, loco_prs, prs_mask, chunk_size, window_bp, do_windows, max_window_chunks, genes, max_gene_snps, min_gene_snps, alpha, covariates, cov_df, SPA, spa_pval_threshold, binary, binary_raw, coher, chr, out_file, batch_size, n_threads));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_StratGWAS_stratgwas_run", (DL_FUNC) &_StratGWAS_stratgwas_run, 25},
