...
he_chunk_spa <- function(filename, pheno_mat, chunk_size = 256L, flank_chunks = 1L, min_chunk_snps = 5L, alpha = -1.0, alpha_common = -1.0, common_filename = NULL, common_window = NA_real_, max_common_snps = 256L, out_file = "", batch_size = 64L, n_threads = 0L, weights = NULL, covariates = NULL, SPA = TRUE, spa_pval_threshold = 0.1, binary = FALSE, annotation = NULL, annot_names = NULL, chr = NULL, flank_categories = NULL, project_common = FALSE, off_diag = FALSE, cov_df = NA_real_, coher = FALSE, pairs = NULL) {
