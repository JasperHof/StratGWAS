...
burden_enrich_association <- function(bed_prefix, he_file = "", category_file = "", trait_name = "", pheno_mat = NULL, out_file = "", kb_size = -1, n_snps_per_window = -1L, target_mac_per_ind = -1, min_enrichment = 0.0, write_buffer_size = 500L, chunk_size = 5000L) {
...
compute_burden_windows <- function(bed_prefix, out_file, kb_size = -1, n_snps_per_window = -1L, target_mac_per_ind = -1, write_buffer_size = 500L, chunk_size = 5000L, effects_file = "", write_burden_scores = TRUE, annotation = NULL, annot_names = NULL) {
    invisible(.Call(`_StratGWAS_compute_burden_windows`, bed_prefix, out_file, kb_size, n_snps_per_window, target_mac_per_ind, write_buffer_size, chunk_size, effects_file, write_burden_scores, annotation, annot_names))
}
...
he_chunk_spa <- function(filename, pheno_mat, chunk_size = 256L, flank_chunks = 1L, min_chunk_snps = 5L, alpha = -1.0, alpha_common = -1.0, common_filename = NULL, common_window = NA_real_, max_common_snps = 256L, out_file = "", batch_size = 64L, n_threads = 0L, weights = NULL, covariates = NULL, SPA = TRUE, spa_pval_threshold = 0.1, binary = FALSE, annotation = NULL, annot_names = NULL, chr = NULL, flank_categories = NULL, project_common = FALSE, off_diag = FALSE, cov_df = NA_real_, coher = FALSE, pairs = NULL, binary_raw = NULL, binary_gap = NULL, grm_prefix = NULL, grm_probes = 64L, grm_seed = 1L) {
...
stratgwas_run <- function(filename, pheno_mat, annotation = NULL, annot_names = NULL, loco_prs = NULL, prs_mask = NULL, chunk_size = 256L, window_bp = 1e6, do_windows = TRUE, max_window_chunks = 8L, genes = NULL, max_gene_snps = 512L, min_gene_snps = 2L, alpha = -1.0, covariates = NULL, cov_df = NA_real_, SPA = TRUE, spa_pval_threshold = 0.1, binary = FALSE, binary_raw = NULL, coher = FALSE, chr = NULL, out_file = "", batch_size = 64L, n_threads = 0L) {
    .Call(`_StratGWAS_stratgwas_run`, filename, pheno_mat, annotation, annot_names, loco_prs, prs_mask, chunk_size, window_bp, do_windows, max_window_chunks, genes, max_gene_snps, min_gene_snps, alpha, covariates, cov_df, SPA, spa_pval_threshold, binary, binary_raw, coher, chr, out_file, batch_size, n_threads)
}
